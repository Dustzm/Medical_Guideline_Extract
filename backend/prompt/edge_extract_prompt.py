...
- **valueTag抽取要求**：
    - valueTag需要与value对应，例如：entity："通讯作者姓名"，property："邮箱"，valueTag："邮箱"
...
- **基本信息要求说明**：
    - 抽取的第一级为：本指南	基本信息	基本信息	主实体	临床实践指南基本信息	1
    - 所有的基本信息都在"基本信息"实体下，property为基本信息的property，value为对应的value
...
- **背景信息要求说明**：
    - 抽取的第一级为：本指南	有…背景	背景	主实体	临床实践指南背景	1
    - 所有的背景信息都在"背景"实体下，property为背景的property，value为对应的value
...
- **利益冲突抽取说明**：有三种利益冲突，都需要提取
    - 非经济利益冲突声明
    - 经济利益冲突声明
    - 间接利益冲突声明
- **方法要求说明**：
    - 抽取的第一级为：本指南	方法	方法	主实体	临床实践指南制订方法	1
    - 所有的方法信息都在"方法"实体下，property为方法的property，value为对应的value
...
- **证据质量与推荐意见要求说明**：
    - 抽取的第一级为：本指南	的	证据质量与推荐意见分级标准	主实体	证据质量与推荐意见分级标准	1
    - 所有的证据质量与推荐意见分级标准信息都在"证据质量与推荐意见分级标准"实体下，property为分级标准的property，value为对应的value
